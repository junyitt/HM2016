...
##################
        ...
        #cbind
            Bondprice_final_df <- cbind(Code = BondCode_v, BondPrice = bondprice_v)
        #output
...
########################################
        ...
        #cbind    
        fwdprice_final_df <- cbind(Code = FwdCode_v, FWD = fwdprice_v)
        #output
    ...
    ##############################      
        ...
        #cbind    
        optionprice_final_df <- cbind(Code = c(OptionCode_v, PutOptionCode_v), PREMIUM = c(callprem_v, putprem_v))
        #output
